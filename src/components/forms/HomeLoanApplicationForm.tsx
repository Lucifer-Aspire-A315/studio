...
const homeLoanSections = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "permanentAddress.fullAddress", label: "Permanent Address", type: "text", placeholder: "Enter your permanent full address", colSpan: 2 },
    ]
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "existingLoans.outstandingAmount", label: "If Yes, Outstanding Amount (₹)", type: "number", placeholder: "Outstanding amount", prefix: "₹" },
      { name: "existingLoans.emiAmount", label: "If Yes, EMI Amount (₹)", type: "number", placeholder: "EMI amount", prefix: "₹" },
    ]
  },
  {
...
export function HomeLoanApplicationForm({ setCurrentPage }: HomeLoanApplicationFormProps) {
  const defaultValues: HomeLoanApplicationFormData = {
    ...
    isPermanentAddressDifferent: "no", // Default to "no"
    ...
    hasExistingLoans: "no", // Default to "no"
    existingLoans: {
      bankName: '',
