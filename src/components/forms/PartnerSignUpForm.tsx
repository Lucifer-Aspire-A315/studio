  ...
  async function onSubmit(data: PartnerSignUpFormData) {
    ...
    try {
      ...
      if (result.success && result.user) {
        ...
        // Log in the user optimistically on the client side, but their server access is still pending approval
        // This provides a better UX than just leaving them on the signup page.
        // The backend correctly sets them as unapproved.
        login(result.user);
        form.reset();
        router.push('/');
      } else {
